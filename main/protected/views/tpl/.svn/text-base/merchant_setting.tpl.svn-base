<script src="/main/js/ajaxFileUpload.js" type="text/javascript"></script>
<style>
#float_search_bar{
  z-index: 2012;
  position: absolute;
              ...
              <form class="form-horizontal">
                <fieldset>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text"  class="input-large" disabled value="<{$id}>">
                    </div>
                  </div>                 
                  <{/if}>
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" placeholder="请输入店铺名称" class="input-large" id="name" value="<{$name}>">
                    </div>
                  </div>
                  <div class="control-group">
                    <!-- Select Basic -->
                    ...
                    <div class="controls">
                      <select class="input-large" id="category" value=<{$category}>>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" placeholder="请输入店铺手机号" class="input-large" id="phone" value="<{$phone}>">
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <div class="input-append">
                       <input class="m-wrap input-medium" type="text" placeholder="请输入店铺地址" id="address"  value="<{$address}>">
                 ...
                 <div class="control-group">
                  ...
                  <div class="controls">
                    <input id="coordinate" type="text" placeholder="请在地图上标注店铺的坐标" class="input-large" disabled id="coordinate"  value="<{$coordinate}>">
                    <p class="help-block"></p>
                  </div>
                </div>
                <div class="control-group">
                  ...
                  <div class="controls">
                    <div class="textarea">
                      <textarea type="" class="input-large"  id="introduction"><{$introduction}></textarea>
                    </div>
                  </div>
                </div>
                
                <{if $merchantLevel ne 3}>      
                <div class="control-group">
                  <label class="control-label">店铺Logo</label>
                  <div class="controls">
                    <img id="logopic" src="<{$logo}>" alt="商品照片" style="width:50px;height:50px;"/>
                  </div>
                </div>                                  
                <div class="control-group">
...
for(var i=0;i<category.options.length;i++){
  if(category.options[i].innerHTML == "<{$category}>"){

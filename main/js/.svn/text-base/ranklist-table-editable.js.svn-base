...
//                jqTds[5].innerHTML = '<a class="cancel" href="">取消</a>';
            ...
            function saveRow(oTable, nRow) {
                ...
                var data = {
                    ...
                    "merchantId"   : jqInputs[0].value,
                };
                $.ajax({
                    url: "/main/index.php?r=ranklist/setting",
                    type: 'POST',
                    data: data,
                    dataType: "json",
                    success: function(result){
                        if(result.errno==0){
                            ...
                            // oTable.fnUpdate('<a class="picture" href="/main/index.php?r=ranklist/picture">管理图片</a>', nRow, 6, false);
                            oTable.fnDraw();
                            nEditing = null;
                        }
            ...
            var dataid;
            var oTable = $('#ranklist_editable').dataTable({
                "aLengthMenu": [
                    [5, 10, 20, -1],
            ...
            jQuery('#ranklist_editable_wrapper .dataTables_filter input').addClass("m-wrap medium"); // modify table search input
            jQuery('#ranklist_editable_wrapper .dataTables_length select').addClass("m-wrap xsmall"); // modify table per page dropdown

            var nEditing = null;

            $('#ranklist_editable_new').click(function (e) {
                e.preventDefault();
            ...
            $('#ranklist_editable a.delete').live('click', function (e) {
                e.preventDefault();
            ...
            $('#ranklist_editable a.cancel').live('click', function (e) {
                e.preventDefault();
            ...
            $('#ranklist_editable a.picture').live('click', function (e) {
                e.preventDefault();
            ...
            $('#ranklist_editable a.edit').live('click', function (e) {
                e.preventDefault();
